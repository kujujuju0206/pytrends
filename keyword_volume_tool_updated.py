...
# !pip install requests pandas numpy matplotlib seaborn ipywidgets openpyxl
        ...
        for keyword in keywords:
            ...
            for i in range(months):
                ...
                if platform == 'TikTok':
                    ...
                    platform_factor = 1.0 + (0.08 * (months - i) / months)
                elif platform == 'X':
                    platform_factor = 1.0 + (0.03 * (months - i) / months)
...
def test_with_demo_data():
    ...
    platforms = ['Google', 'YouTube', 'X', 'TikTok']
    ...
    plot_trends_matplotlib(combined_df, 12)
...
platform_checkboxes = {
    ...
    'YouTube': widgets.Checkbox(value=False, description='YouTube'),
    'X': widgets.Checkbox(value=False, description='X (旧Twitter)'),
...
def main():
    ...
    platform_options = ['Google', 'YouTube', 'X', 'TikTok']
